        ...
        if (result != null) {
            ...
            if (provinceSoapObject.getProperty("Sucess").toString().equals("true")) {
                ...
                if (method.equals("GetAllCodeLastChangeTime")) {
                    ...
                    invokeReturn.setObj((Version) obj);
                } else {
                    try {
                        Object obj = provinceSoapObject.getProperty("Obj");
                        ...
                        if (method.equals("GetRoomRate")) {
                        ...
                        } else if ("GetMobileVersion".equals(method)) {
                            Version version = new Version();
                            version.setVersion(soaplist.getProperty(0).toString());
                            version.setLink(soaplist.getProperty(1).toString());
                            invokeReturn.setObj(version);
                            ...
                            for (int i = 0; i < soaplist.getPropertyCount(); i++) {
                                ...
                                if (method.equals("GetCodeInfoByCodeName")) {
                                    ...
                                    if (model.getName().equals("小兵")) {
                                        String kkk = soapObject.getProperty("NBZP").toString();
