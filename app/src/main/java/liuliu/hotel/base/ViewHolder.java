...
//    public ViewHolder setComapnyImageUrl(int viewId, String url) {
//        ImageView view = getView(viewId);
...
//                result = true;
//                view.setTag(url);
//                view.setImageBitmap(Utils.centerSquareScaleBitmap(Utils.getLoacalBitmap(url), 60));
//            }
//        }
//        if (!result) {
//            view.setImageResource(R.mipmap.company_moren);
//        }
//        return this;
//    }

//    public ViewHolder setPersonImageUrl(int viewId, String url) {
//        ImageView view = getView(viewId);
//        boolean result = false;
//        if (url != null) {
//            if (!url.equals("")) {
...
//        }
//        if (!result) {
//            view.setImageResource(R.mipmap.center_picture);
//        }
//        return this;
//    }

//    public ViewHolder setPoliceImageUrl(int viewId, String url) {
//        ImageView view = getView(viewId);
//        boolean result = false;
//        if (url != null) {
